...
# constants
KEYWORDS="PV|CM|OP|オープニング|ED|エンディング|紹介|ティザー|Teaser|Trailer|番宣|キャラクター|劇中曲|挿入歌|イントロダクション|ライブシーン|告知映像|トレーラー|主題歌|解説動画|本予告|特別映像|Music Video|ボイスドラマ|ミニアニメ|科学講座|劇場|予告編|スペシャルムービー|ミュージッククリップ|ピックアップシーン|プロモーションリール|ショートアニメ|カルテ|ミニドラマ|紹介動画"
